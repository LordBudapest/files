...
external ml_gtktree_init : unit -> unit = "ml_gtktree_init"
let () = ml_gtktree_init ()
...
module TreeView = struct
  ...
  module P = struct
    ...
    let enable_grid_lines : ([>`treeview],_) property =
      {name="enable-grid-lines"; conv=GtkEnums.Conv.tree_view_grid_lines}
    let enable_tree_lines : ([>`treeview],_) property =
      {name="enable-tree-lines"; conv=boolean}
  ...
  module S = struct
    ...
    let move_cursor =
      {name="move_cursor"; classe=`treeview; marshaller=fun f ->
       marshal2_ret ~ret:boolean GtkEnums.Conv.movement_step int
...
module CellRenderer = struct
  ...
  module P = struct
    ...
    let mode : ([>`cellrenderer],_) property =
      {name="mode"; conv=GtkEnums.Conv.cell_renderer_mode}
...
module CellRendererPixbuf = struct
  ...
  module P = struct
    ...
    let stock_size : ([>`cellrendererpixbuf],_) property =
      {name="stock-size"; conv=GtkEnums.Conv.icon_size}
  end
...
module CellRendererText = struct
  ...
  module P = struct
    ...
    let stretch : ([>`cellrenderertext],_) property =
      {name="stretch"; conv=PangoEnums.Conv.stretch}
    ...
    let style : ([>`cellrenderertext],_) property =
      {name="style"; conv=PangoEnums.Conv.style}
    ...
    let wrap_mode : ([>`cellrenderertext],_) property =
      {name="wrap-mode"; conv=PangoEnums.Conv.wrap_mode}
    let wrap_width : ([>`cellrenderertext],_) property =
...
module CellRendererAccel = struct
  ...
  module P = struct
    ...
    let accel_mode : ([>`cellrendereraccel],_) property =
      {name="accel-mode"; conv=GtkEnums.Conv.cell_renderer_accel_mode}
...
module TreeViewColumn = struct
  ...
  module P = struct
    ...
    let expand : ([>`treeviewcolumn],_) property =
      {name="expand"; conv=boolean}
...
module IconView = struct
  ...
  module P = struct
    ...
    let selection_mode : ([>`iconview],_) property =
      {name="selection-mode"; conv=GtkEnums.Conv.selection_mode}
  ...
  external get_path_at_pos :
    [>`iconview] obj -> int -> int -> Gtk.tree_path option
